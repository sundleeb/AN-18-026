...
\title{Search for Dark Higgs Production}
...
pdftitle={Search for Dark Higgs Production},%
pdfsubject={CMS},%
...
The latest version of the acknowledgments will be included from \url{https://twiki.cern.ch/twiki/bin/viewauth/CMS/Internal/PubAcknow} as of the date of submission.
